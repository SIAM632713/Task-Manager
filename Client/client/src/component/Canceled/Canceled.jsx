...
const Canceled = () => {
    ...
    const Canceleddlist = useSelector((state) => state.task.canceled);
    ...
    return (
        <div>
            <div className="flex items-center justify-between">
                <div>
                    <h1 className="text-xl font-semibold">Task In Canceled</h1>
                </div>
                <div>
                ...
                {Canceleddlist.map((item, index) => (
                    ...
                    >
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <button
                                className="px-3 py-1 rounded-full bg-red-400 text-sm text-white hover:bg-red-500 transition-all cursor-pointer"
                            >
                                {item.status}
                            </button>
                        </div>
