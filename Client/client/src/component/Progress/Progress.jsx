    ...
    return (
        <div>
            <div className="flex items-center justify-between">
                <div>
                    <h1 className="text-xl font-semibold">Task In Progress</h1>
                </div>
                <div>
                ...
                {Progresslist.map((item, index) => (
                    ...
                    >
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <button
                                className="px-3 py-1 rounded-full bg-red-600 text-sm text-white hover:bg-red-700 transition-all cursor-pointer"
                            >
                                {item.status}
                            </button>
                        </div>
