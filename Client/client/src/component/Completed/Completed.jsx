    ...
    return (
        <div>
            <div className="flex items-center justify-between">
                <div>
                    <h1 className="text-xl font-semibold">Task In Completed</h1>
                </div>
                <div>
                ...
                {Completedlist.map((item, index) => (
                    ...
                    >
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <button
                                className="px-3 py-1 rounded-full bg-green-400 text-sm text-white hover:bg-green-500 transition-all cursor-pointer"
                            >
                                {item.status}
                            </button>
                        </div>
